...
const Services = () => {
    ...
    return(	<div className="w-full py-20 bg-gradient-to-t from-sky-800 via-cyan-800 to-teal-600">
	...
	return (
		<div className="w-full flex items-center justify-between">
			<div className="w-7/12 flex flex-col gap-4">
				<h4 className="text-5xl font-bold"><span className="tracking-wider text-white font-sans">Our</span>
								<span className="text-5xl text-green-500">Services</span>{subtitle}</h4>
